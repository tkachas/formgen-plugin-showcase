...
export type UserConfig = Plugin.Name<"formgen"> & {
  targetSchemas: TargetSchemasConfigMap;
  /**
...
type TargetSchemasConfigStructure = {
  excludeFields?: string[];
};

type NormalizeableTargetSchemaStructure<T> = T | true;

type TargetSchemasConfigMap = Record<
  string,
  NormalizeableTargetSchemaStructure<TargetSchemasConfigStructure>
>;
...
export type FormgenPlugin = DefinePlugin<UserConfig, Config, Api>;
